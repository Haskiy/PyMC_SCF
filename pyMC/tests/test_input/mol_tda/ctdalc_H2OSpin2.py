...
'''
Author: Li Hao
Date: 2022-04-13 16:41:16
LastEditTime: 2022-04-14 14:52:17
LastEditors: Li Hao
...
FilePath: \pyMC\tests\test_input\mol_tda\ctdalc_H2OSpin2.py
Motto: A + B = C!
'''
...
# where 0 -> (SVWN) and the first (0,1) -> (None, 1e-10).
BENCHMARK_Extd = numpy.load(PATH_Bechdata +'ctdalc_H2OSpin2_Extd.npy',allow_pickle=True).item()
BENCHMARK_Name = numpy.load(PATH_Bechdata +'ctdalc_H2OSpin2_BechName.npy',allow_pickle=True).item()
