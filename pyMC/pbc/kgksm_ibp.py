'''
Author: Li Hao
Date: 2021-11-17 14:56:03
LastEditTime: 2022-03-23 11:53:07
LastEditors: Pu Zhichen
Description: 

FilePath: \pyMC\pbc\kgksm_ibp.py
Motto: A + B = C!
'''
import time
import numpy 
...
def get_veff(ks, cell=None, dm=None, dm_last=0, vhf_last=0, hermi=1,
    ...
    # import pdb
    # pdb.set_trace()
    n, exc, vxctmp = ks._numint.nrk_new_ASDP_parallel_ibp(cell, ks.grids, ks.xc, dm,
...
class KGKSM_IBP(rks.KohnShamDFT, kghf.KGHF):
...
if __name__ == '__main__':
    ...
    cell.build()
    mf = KGKSM_IBP(cell, cell.make_kpts([2,1,1]))
    print(mf.kernel())