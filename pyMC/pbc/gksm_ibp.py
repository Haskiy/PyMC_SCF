...
LastEditTime: 2022-03-14 15:13:07
LastEditors: Li Hao
Description: 

FilePath: \pyMC\pbc\gksm_ibp.py
Motto: A + B = C!
'''
'''
See pyMC.gksm_util.gksm_ibp also.
'''
...
def get_veff(ks, cell=None, dm=None, dm_last=0, vhf_last=0, hermi=1, 
    ...
    '''Coulomb + XC functional for GKS of PBC with ibp. 
    '''
    # import pdb
    # pdb.set_trace()

    if cell is None: cell = ks.mol
    ...
    n, exc, vxctmp = ks._numint.nr_new_ASDP_parallel_ibp(cell, ks.grids, ks.xc, dm,
...
class GKSM_IBP(rks.KohnShamDFT, pbcghf.GHF):
    '''Generalized Kohn-Sham with spherical average for PBCs with ibp'''
