...
'''
Author: Li Hao
Date: 2022-04-08 13:04:30
LastEditTime: 2022-04-12 10:31:59
LastEditors: Li Hao
Description: Lebedev sample points and weights on the sphere surface.
             Note: All this code is finished by Sun Qiming.
FilePath: \pyMC\lib\LebedevGrid.py
Motto: A + B = C!
'''
import numpy as np
...
def MakeLebedevGrid(nPoints):
    if nPoints == 1:      grids = np.array((0., 0., 0., 1.))
    elif nPoints == 6:    grids = MakeAngularGrid_6   ()
    elif nPoints == 14:   grids = MakeAngularGrid_14  ()
    elif nPoints == 26:   grids = MakeAngularGrid_26  ()
    elif nPoints == 38:   grids = MakeAngularGrid_38  ()
    elif nPoints == 50:   grids = MakeAngularGrid_50  ()
    elif nPoints == 74:   grids = MakeAngularGrid_74  ()
    elif nPoints == 86:   grids = MakeAngularGrid_86  ()
    elif nPoints == 110:  grids = MakeAngularGrid_110 ()
    elif nPoints == 146:  grids = MakeAngularGrid_146 ()
    elif nPoints == 170:  grids = MakeAngularGrid_170 ()
    elif nPoints == 194:  grids = MakeAngularGrid_194 ()
    elif nPoints == 230:  grids = MakeAngularGrid_230 ()
    elif nPoints == 266:  grids = MakeAngularGrid_266 ()
    elif nPoints == 302:  grids = MakeAngularGrid_302 ()
    elif nPoints == 350:  grids = MakeAngularGrid_350 ()
    elif nPoints == 434:  grids = MakeAngularGrid_434 ()
    elif nPoints == 590:  grids = MakeAngularGrid_590 ()
    elif nPoints == 770:  grids = MakeAngularGrid_770 ()
    elif nPoints == 974:  grids = MakeAngularGrid_974 ()
    elif nPoints == 1202: grids = MakeAngularGrid_1202()
    elif nPoints == 1454: grids = MakeAngularGrid_1454()
    elif nPoints == 1730: grids = MakeAngularGrid_1730()
    elif nPoints == 2030: grids = MakeAngularGrid_2030()
    elif nPoints == 2354: grids = MakeAngularGrid_2354()
    elif nPoints == 2702: grids = MakeAngularGrid_2702()
    elif nPoints == 3074: grids = MakeAngularGrid_3074()
    elif nPoints == 3470: grids = MakeAngularGrid_3470()
    elif nPoints == 3890: grids = MakeAngularGrid_3890()
    elif nPoints == 4334: grids = MakeAngularGrid_4334()
    elif nPoints == 4802: grids = MakeAngularGrid_4802()
    elif nPoints == 5294: grids = MakeAngularGrid_5294()
    elif nPoints == 5810: grids = MakeAngularGrid_5810()
    else:
        raise ValueError(f'grid size {nPoints} not available.')
    return grids
